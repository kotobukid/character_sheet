        ...
        <div id="base_status">
            <table>
                ...
                <tr>
                    ...
                    <td>{Math.floor((props.skill + props.a + props.a_growth) / 6)}</td>
                </tr>
                <tr>
                    ...
                    <td>{Math.floor((props.skill + props.b + props.b_growth) / 6)}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>{Math.floor((props.body + props.c + props.c_growth) / 6)}</td>
                </tr>
                <tr>
                    ...
                    <td>{Math.floor((props.body + props.d + props.d_growth) / 6)}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>{Math.floor((props.mental + props.e + props.e_growth) / 6)}</td>
                </tr>
                <tr>
                    ...
                    <td>{Math.floor((props.mental + props.f + props.f_growth) / 6)}</td>
                </tr>
                </tbody>
            </table>
        </div>
